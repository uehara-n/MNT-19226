...
function my_acf_init() {
  acf_update_setting('google_api_key', 'AIzaSyA8K9kIdvQDFfKE4j02Sgj_YYZR_szIVBU');
}
...
function modelhouse_archives () {
	...
	<p class="more"><a href="<?php bloginfo('url'); ?>/showroom_hon">詳細を見る &gt;&gt;</a></p></div></li>
	<li>
	...
	<p class="more"><a href="<?php bloginfo('url'); ?>/showroom_osaka">詳細を見る &gt;&gt;</a></p></div></li>
	<li>
	...
	<p class="more"><a href="<?php bloginfo('url'); ?>/showroom_higashiosaka">詳細を見る &gt;&gt;</a></p></div></li>
...
<p class="more"><a href="<?php the_permalink(); ?>">詳細を見る &gt;&gt;</a></p></div>
</li>
<? $i++;
